...
def get_questions_text(i):

    inpath_init = '/home/harshita/Desktop/Question_Generation/Samples/Input'+i+'.txt'
    inpath = '/home/harshita/Desktop/Question_Generation/Samples/Input_new'+i+'.txt'
    outpath= '/home/harshita/Desktop/Question_Generation/Samples/Output'+i+'.json'
    midpath = '/home/harshita/Desktop/Question_Generation/Samples/CMU'+i+'.txt'
...
#    subprocess.run(["/home/harshita/Desktop/Question_Generation/run_from_file_sample.sh",inpath, midpath])
#
...
if __name__ == "__main__":
   for i in (range(1,2)):
       (get_questions_text(str(i)))

# if __name__ == "__main__":
#    (get_questions_text('8'))
